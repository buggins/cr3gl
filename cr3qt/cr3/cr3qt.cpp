...
static int translateKeyCode(int key) {
    ...
    case Qt::Key_A: return CR_KEY_A;
    case Qt::Key_B: return CR_KEY_B;
    case Qt::Key_C: return CR_KEY_C;
    case Qt::Key_D: return CR_KEY_D;
    case Qt::Key_E: return CR_KEY_E;
    case Qt::Key_F: return CR_KEY_F;
    case Qt::Key_G: return CR_KEY_G;
    case Qt::Key_H: return CR_KEY_H;
    case Qt::Key_I: return CR_KEY_I;
    case Qt::Key_J: return CR_KEY_J;
    case Qt::Key_K: return CR_KEY_K;
    case Qt::Key_L: return CR_KEY_L;
    case Qt::Key_M: return CR_KEY_M;
    case Qt::Key_N: return CR_KEY_N;
    case Qt::Key_O: return CR_KEY_O;
    case Qt::Key_P: return CR_KEY_P;
    case Qt::Key_Q: return CR_KEY_Q;
    case Qt::Key_R: return CR_KEY_R;
    case Qt::Key_S: return CR_KEY_S;
    case Qt::Key_T: return CR_KEY_T;
    case Qt::Key_U: return CR_KEY_U;
    case Qt::Key_V: return CR_KEY_V;
    case Qt::Key_W: return CR_KEY_W;
    case Qt::Key_X: return CR_KEY_X;
    case Qt::Key_Y: return CR_KEY_Y;
    case Qt::Key_Z: return CR_KEY_Z;
...
//    }
    ...
    crconfig.desktopMode = true;

    crconfig.touchMode = true;

    // testing EINK mode
    crconfig.einkMode = false;
