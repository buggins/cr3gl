...
S(ERROR_CANNOT_CREATE_DIRECTORY)
S(ERROR_CANNOT_REMOVE_DIRECTORY)
S(CREATE_FOLDER_POPUP_TITLE)
...
S(SETTINGS_APP_DICTIONARY)
S(SETTINGS_APP_DICTIONARY_STATE_INSTALLED)
S(SETTINGS_APP_DICTIONARY_STATE_NOT_INSTALLED)
...
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_SYSTEM)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_1MIN)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_2MIN)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_3MIN)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_5MIN)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_10MIN)
S(SETTINGS_APP_SCREEN_BACKLIGHT_TIMEOUT_VALUE_15MIN)

S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS)
S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_VALUE_SYSTEM)

S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_TOUCH_CONTROL)
S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_TOUCH_CONTROL_VALUE_ON)
S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_TOUCH_CONTROL_VALUE_OFF)
S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_TOUCH_CONTROL_TOAST_VALUE)
S(SETTINGS_APP_SCREEN_BACKLIGHT_BRIGHTNESS_TOUCH_CONTROL_TOAST_SYSTEM)
