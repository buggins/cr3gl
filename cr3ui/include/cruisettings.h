...
#define PROP_BACKGROUND_IMAGE_CORRECTION_CONTRAST "background.image.correction.brightness"
#define PROP_BACKGROUND_IMAGE_CORRECTION_CONTRAST_DAY "background.image.correction.brightness.day"
#define PROP_BACKGROUND_IMAGE_CORRECTION_CONTRAST_NIGHT "background.image.correction.brightness.night"
