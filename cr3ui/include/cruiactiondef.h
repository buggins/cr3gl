...
CRACTION_UI(OPEN_BOOK, "book")
CRACTION_UI(CURRENT_BOOK, "book")
CRACTION_UI(PREVIOUS_BOOK, "available_updates")
CRACTION_UI(GOTO_PERCENT, "arrow")
CRACTION_UI(TOC, "document")
CRACTION_UI(TTS_PLAY, "listen")
...
CRACTION_UI(OPEN_CURRENT_BOOK_FOLDER, "folder_icon")
CRACTION_UI(REMOVE_BOOK_FILE, "remove_file")
CRACTION_UI(REMOVE_BOOK_HISTORY, "remove_list")
CRACTION_UI(CREATE_FOLDER, "add_folder")
CRACTION_UI(REMOVE_FOLDER, "remove_folder")
CRACTION_UI(FIND_IN_DICTIONARY, "generic_text")
